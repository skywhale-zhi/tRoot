...
{
    public class MoireWoodBed : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			name.AddTranslation(7,"云纹木床");
			name.AddTranslation(1, "Moire Wood Bed");
		...
		{
			Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 64, 32, ModContent.ItemType<Items.Placeable.Furniture.MoireWoodBed>());
		}
		...
		public override void MouseOver(int i, int j)
		{
			...
			else
			{
				player.noThrow = 2;
				player.cursorItemIconEnabled = true;
				player.cursorItemIconID = ModContent.ItemType<Items.Placeable.Furniture.MoireWoodBed>();
			}
		}
	}
}
